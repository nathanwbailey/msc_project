...
def objective(trial):
    ...
    temperature = trial.suggest_categorical("temperature", [0.01, 0.03, 0.05, 0.07, 0.08, 0.1, 0.3, 0.5])
    decay = 0.9
    ...
    plot_tsne(train_data=train_data, valid_data=valid_data, train_labels=train_labels, valid_labels=valid_labels, filename=f'tsne_plots/{param_str}.png', decay=decay, model=model),
