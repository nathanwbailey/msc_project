...
def main():
    ...
    train_model(model, num_epochs, trainloader, testloader, optimizer, scheduler, DEVICE, loss_fn, model_save_path='barlow_main.pth')
    ...
    downstream_task(num_epochs=100, data=test_data, encoder_model=model.encoder, latent_dim=1000, context_window=30, target_length=1, stride=1)
