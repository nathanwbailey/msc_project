...
def main():
    ...
    downstream_task_lstm(num_epochs=100, data=test_data, encoder_model=model_decoder.model.encoder, latent_dim=1000, context_window=30, target_length=100, stride=1, batch_size=16, model_save_path='downstream_model_no_decoder_cw_30_t_100.pth')
