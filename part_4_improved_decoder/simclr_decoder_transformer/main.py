...
from downstream_task_transformer_no_decoder.downstream_task_transformer_main import downstream_task
...
def main():
    ...
    downstream_task(num_epochs=100, data=test_data, encoder_model=model_decoder.model.encoder, latent_dim=1000, context_window=30, target_length=1, stride=1, model_save_path='downstream_model_no_decoder.pth')
