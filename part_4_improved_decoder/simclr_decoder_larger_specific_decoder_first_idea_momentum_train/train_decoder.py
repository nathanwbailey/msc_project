...
def train_encoder_decoder(model, momentum_model, num_epochs, trainloader, testloader, optimizer, scheduler, device, loss_fn_contrastive, loss_fn_reconstruct, cycle_loss, model_save_path="barlow_twins.pth", add_l1=False, add_l2=False, l1_lambda=1e-6, l2_lambda=1e-6):
    for epoch in range(num_epochs):
        total_train_loss = []
        recon_train_loss = []
        recon_train_loss_2 = []
