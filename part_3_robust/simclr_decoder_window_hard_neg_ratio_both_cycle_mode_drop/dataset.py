...
class WeatherBenchDataset(Dataset):
    ...
    def _create_sample(self, idx):
        ...
        x_prime, channel_2 = augment_sample_random_mask(
            X_prime,
            channel=channel,
            mask_prob_low=self.mask_prob_low,
            mask_prob_high=self.mask_prob_high,
        )
        x_prime_2, _ = augment_sample_random_mask(
            X_prime_2,
    ...
    def __getitem__(self, idx):
        ...
        x_soft, x_prime_soft, x_prime_2_soft, X_soft, X_masked_soft = (
            self._create_sample(soft_idx)
        )
        x_hard, x_prime_hard, x_prime_2_hard, X_hard, X_masked_hard = (
