...
def main():
    ...
    C, H, W = next(iter(trainloader))["x_pos_1"].shape[2:]  # Adjusted for dict output
    ...
    downstream_configs = [
        ...
        {"context_window": 5, "stride": 1, "save": "downstream_model_no_decoder_weight_decay_cw_5_2.pth"},
