...
def train_encoder_decoder(
    ...
    for epoch in range(num_epochs):
        ...
        for data in trainloader:
            ...
            weights = get_loss_weights(idx, batch_size, max_train)

            loss_fn_contrastive.set_weights(weights)

            loss_1 = loss_fn_contrastive(embeddings_delta, labels)
        ...
        with torch.no_grad():
            for data in testloader:
                ...
                weights = get_loss_weights(idx, batch_size, max_valid)
