...
from loss import WeightedNTXentLoss, WeightedLossWrapper
...
# https://arxiv.org/pdf/2312.16424
...
def main():
    ...
    loss_fn_contrastive = WeightedLossWrapper(loss_fn=WeightedNTXentLoss(temperature=0.3))
    ...
    #     loss_fn_contrastive, cycle_loss, max_train, max_valid, model_save_path="simclr.pth"
    # )
