...
def train_encoder_decoder(
    ...
    for epoch in range(num_epochs):
        ...
        total_train_loss, recon_train_loss, recon_train_loss_2, contrastive_train_loss, cycle_train_loss = [], [], [], [], []
        total_valid_loss, recon_valid_loss, recon_valid_loss_2, contrastive_valid_loss, cycle_valid_loss = [], [], [], [], []
